...
import { Storage, StorageOptions } from '@prologify/storage/core';
...
let st: Storage;
const bsOptions: StorageOptions = {
  name: 'websqlDBName',
...
beforeEach(() => {
  st = new Storage({...bsOptions, drivers: [new WebsqlDriver(websqlOptions)]});
});
